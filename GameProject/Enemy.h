...
UENUM(BlueprintType)
enum class EEnemyMovementStats : uint8
{
...
public:
	...
	EEnemyMovementStats EnemyMovevmentStats;

	FORCEINLINE void SetEnemyMovementStatus(EEnemyMovementStats StatusToSet) { EnemyMovevmentStats = StatusToSet; }

	FORCEINLINE EEnemyMovementStats GetEnemyMovementStatus() { return EnemyMovevmentStats; }
